...
namespace pycs.modules
{
    public static class json
    {
        ...
        public static T? load<T>(Stream stream) => loads<T>(new TextIO(stream).read().ToStandard());
        public static object? load(Stream stream) => loads(new TextIO(stream).read().ToStandard());
