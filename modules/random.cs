...
namespace pycs.modules
{
    public static class random 
    {
        ...
        {
            if (length > arr.Length) throw new ArgumentOutOfRangeException("Length greater than array's length");
        ...
        {
            if (length > dict.Count) throw new ArgumentOutOfRangeException("Length greater than array's length");
        ...
        {
            if (arr.Length == 0) throw new ArgumentOutOfRangeException("No element at index 0");
        ...
        {
            if(list.Count == 0 ) throw new ArgumentOutOfRangeException("No element at index 0");
        ...
        {
            if(dict.Count == 0) throw new ArgumentOutOfRangeException("No element at index 0");
